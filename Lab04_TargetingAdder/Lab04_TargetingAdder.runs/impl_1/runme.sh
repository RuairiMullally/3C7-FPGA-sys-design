...
HD_PWD='C:/Users/ruair/Documents/Vivado/Lab04_TargetingAdder/Lab04_TargetingAdder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log b6_ripple_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source b6_ripple_adder.tcl -notrace
