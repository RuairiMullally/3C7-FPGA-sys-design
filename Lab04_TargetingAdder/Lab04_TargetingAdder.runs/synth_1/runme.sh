...
HD_PWD='C:/Users/ruair/Documents/Vivado/Lab04_TargetingAdder/Lab04_TargetingAdder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log b6_ripple_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source b6_ripple_adder.tcl
