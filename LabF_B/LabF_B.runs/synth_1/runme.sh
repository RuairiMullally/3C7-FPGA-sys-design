...
HD_PWD='C:/Users/ruair/Documents/Vivado/LabF_B/LabF_B.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dff_8b_temp_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dff_8b_temp_mem.tcl
