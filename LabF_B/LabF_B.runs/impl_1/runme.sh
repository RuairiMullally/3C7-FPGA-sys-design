...
HD_PWD='C:/Users/ruair/Documents/Vivado/LabF_B/LabF_B.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dff_8b_temp_mem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dff_8b_temp_mem.tcl -notrace
