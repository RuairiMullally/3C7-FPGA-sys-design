...
HD_PWD='C:/Users/ruair/Documents/Vivado/LabF_C_LFSR/LabF_C_LFSR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lfsr_23b_clkdiv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lfsr_23b_clkdiv.tcl
