...
HD_PWD='C:/Users/ruair/Documents/Vivado/LabF_C_LFSR/LabF_C_LFSR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lfsr_23b_clkdiv.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lfsr_23b_clkdiv.tcl -notrace
