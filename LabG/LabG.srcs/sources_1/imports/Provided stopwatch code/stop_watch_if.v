             ...
             if (d0_reg != 9)
                ...
                begin
                   ...
                   if (d1_reg != 9)
                      ...
                      begin
                         d1_next = 4'b0;
                         if (d2_reg != 5)//change to on minute update
                            d2_next = d2_reg + 1;
                         else // reach 59.9
                            begin
                                d2_next = 4'b0;
                                if (d3_reg != 9) //added minute increase option
                                    d3_next = d3_reg + 1;
                                else
                                    d3_next = 4'b0;
                            end
          ...
          if (d0_reg != 0)
                ...
                begin
                   ...
                   if (d1_reg != 0)
                      ...
                      begin
                         d1_next = 4'd9;
                         if (d2_reg != 0)//change to on minute update
                            d2_next = d2_reg - 1;
                         else // reach 59.9
                            begin
                                d2_next = 4'd5;
                                if (d3_reg != 0) //added minute increase option
                                    d3_next = d3_reg - 1;
                                else
                                    d3_next = 4'd9;
                            end
